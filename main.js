...
timer_count= document.getElementById('time');
...
if (drawn_sketch == sketch){
    answer_holder= "set";
    score= document.getElementById('point').value;
    score= score+1;
}
